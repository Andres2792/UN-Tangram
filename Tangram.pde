int rotar1 = int(random(0,10));
int rotar2 = int(random(0,10));
int rotar3 = int(random(0,10));
int rotar4 = int(random(0,10));
int rotar5 = int(random(0,10));
int rotar6 = int(random(0,10));
int rotar7 = int(random(0,10));
int nivel = 1;
